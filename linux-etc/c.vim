...
syn match cCppFunctions "\<[a-zA-Z_][a-zA-Z_0-9]*\>[^()]*)("me=e-2
syn match cCppFunctions "\<[a-zA-Z_][a-zA-Z_0-9]*\>\s*("me=e-1
syn match cCppScope     "\<[a-zA-Z_][a-zA-Z_0-9]*\>::"me=e-2
...
hi def link cCppFunctions       Function
hi def link cCppScope           Identifier
